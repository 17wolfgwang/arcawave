  ...
  return (
    <section className="py-16 md:py-24 px-4">
      <div className="max-w-5xl mx-auto">
                  ...
                  >
                    ...
                    <span className="text-gray-700 text-base md:text-lg leading-relaxed">
                      {(() => {
                        ...
                        if (parts.length >= 2) {
                          return <><strong className="text-gray-900">{parts[0]}</strong>{' '}<span className="text-gray-500">{parts[1]}</span></>
                        }
                        return pain
                      })()}
                    </span>
        ...
        >
          {/* Solution Header */}
          <h3 className="text-xl md:text-2xl font-bold text-gray-900 leading-snug mb-6">
            {s.solutionTitle} <span className="text-purple-700">{s.solutionTitleBr}</span>
          </h3>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            {s.solutions.map((sol, i) => (
              ...
              >
                ...
                <span className="font-semibold text-gray-800 text-sm md:text-base">{sol.title}</span>
              </motion.div>
            ))}
          </div>
          ...
          <motion.div
            ...
            className="bg-purple-700/10 rounded-xl px-6 py-3 text-center"
          >
