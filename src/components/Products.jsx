        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 max-w-[900px] mx-auto">
            {t.products.team.map((member, index) => (
              <div key={index} className="bg-white rounded-[20px] p-8 text-center relative" style={{boxShadow: 'rgba(124, 58, 237, 0.08) 0px 2px 8px, rgba(0, 0, 0, 0.05) 0px 1px 3px', ...(index % 2 !== 0 ? {transform: 'none'} : {})}}>
                ...
                <h4 className="mb-2 text-foreground" style={{fontSize: '18px'}}>{member.name}</h4>
                <div className="mb-1 text-sm font-semibold text-primary">{member.school}</div>
                <div className="mb-4 text-sm font-semibold text-secondary">{member.role}</div>
                <p className="text-sm leading-relaxed" style={{color: 'rgb(100, 116, 139)'}}>{member.desc}</p>
              </div>
            ))}
          </div>
          <div className="max-w-[900px] mx-auto">
            <div className="bg-[#F5F0FF] rounded-[20px] p-8 border border-primary/10 relative" style={{opacity: 1, transform: 'none'}}>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h4 className="mb-3 text-foreground" style={{fontSize: '18px'}}>{t.products.advisorTitle}</h4>
                  <p className="text-sm leading-relaxed mb-3" style={{color: 'rgb(100, 116, 139)'}}>{t.products.advisorDesc}</p>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold text-foreground">{t.products.advisorNote}</span>
                  </div>
                </div>
              </div>
            </div>
